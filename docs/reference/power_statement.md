...
#> (APE) of treat using the powerape package (version 1.1.0), following the
...
#> 0.00. The assumed true APE was 0.100 (10.0 percentage points). At a total
#> sample size of n = 800, simulated power for the minimum-effect claim (the 95%
